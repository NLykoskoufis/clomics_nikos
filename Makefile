...
#CXXFLAG_WRN=-Wno-sign-compare -Wno-unused-local-typedefs -Wno-deprecated -Wno-unused-parameter
CXXFLAG_WRN=-w
#LINKER FLAGS
LDFLAG_REL=-O2
LDFLAG_DBG=-g
...
#BASE LIBRARIES
LIB_FLAGS=-lm -lz -lgsl -lgslcblas -llzma -lbz2 -lpthread
...
baobab: CXXFLAG=$(CXXFLAG_REL) $(CXXFLAG_WRN)
baobab: IFLAG=-Ilib/OTools -Ilib -I$(RMATH_INC) -I$(HTSLD_INC) -I$(BOOST_INC)
baobab: LIB_FILES=$(RMATH_LIB)/libRmath.a $(HTSLD_LIB)/libhts.a $(BOOST_LIB)/libboost_iostreams.a $(BOOST_LIB)/libboost_program_options.a
baobab: LDFLAG=$(LDFLAG_REL)
baobab: $(BFILE)
